      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#C84B4B] text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-red-100 text-lg">
            Crea tu cuenta y encuentra todo en útiles escolares y de oficina
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">Gran Variedad</h3>
              <p className="text-red-100 text-sm">Cuadernos, lápices, colores y mucho más</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">Mejores Precios</h3>
              <p className="text-red-100 text-sm">Ofertas especiales para nuestros clientes</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-red-100 text-sm">Productos de las mejores marcas</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-red-100 rounded-full mb-4">
                <UserPlus className="w-8 h-8 text-[#C84B4B]" />
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <p className="text-center text-gray-600 text-sm">
                ...
                <Link href="/login" className="text-[#C84B4B] hover:text-[#a83e3e] font-semibold hover:underline">
                  Inicia sesión
                </Link>
              </p>
            </form>
